...
passport.use("register", new LocalStrategy(
    ...
    //Esta estrategia verifica un token JWT extraído de la cookies y deja acceder a una ruta en caso de ser exitosa
    passport.use("current", new JWTStrategy({
        jwtFromRequest:ExtractJWT.fromExtractors([cookieExtrator]),
        secretOrKey:config.JWT_PRIVATE_KEY, //Debe coincidir con la definida en jwt
