...
app.use(session({
    store:MongoStore.create({
        mongoUrl: 'mongodb+srv://coder:F7717446B2@ecommerce.cmlx1ff.mongodb.net/ecommerce?retryWrites=true&w=majority',
        mongoOptions: { useNewUrlParser: true, useUnifiedTopology: true },
        ttl: 4000
    }),
    secret:"ultraSecret", //Defino la clave de encripción
